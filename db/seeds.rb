...
User.create!(email: 'user@example.com', first_name: 'Ricky', last_name: 'Bobby', password: 'password', github_token: "e55f78a31337b41e2b5f38cfc16fe7cf0b3db2ff", role: :default)
